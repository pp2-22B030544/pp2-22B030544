...
class Wall:
    ...
    def __init__(self, level):
        self.level = level
        self.body = []
        f = open(f"level\level{self.level}.txt", "r")
...
def Score(score,level):
    value = font.render(f"SCORE: {score}",True,(255,135,100))
    screen.blit(value, (0,0))
    uroven = font.render(f'LEVEL: {level}', True,(255,135,100))
...
def main():
    ...
    while status:
        ...
        while close == True:
            ...
            message("Press Space-to continue or Q-Quit", (0,0,0))
